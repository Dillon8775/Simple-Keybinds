# Adds simpler keybinds to Minecraft.
...
<a href="https://fabricmc.net/" target="_blank">
  <img src="https://github.com/Dillon8775/ImageGIFs/blob/universal/Fabric%20Logo.png?raw=true" width="433" height="149" alt="Compatible with Forge">
</a>

####

<a href="https://modrinth.com/mod/fabric-api/versions" target="_blank">
  <img src="https://github.com/Dillon8775/ImageGIFs/blob/universal/Requires%20Fabric%20API%20Logo.png?raw=true" width="286" height="96" alt="Compatible with Forge">
</a>
...
- #### Render Distance (Default Key = *U*)
- #### Entity Distance (Default Key = *H*)
- #### FOV (Default Key = *R*)
- #### Master Volume (Default Key = *M*)
