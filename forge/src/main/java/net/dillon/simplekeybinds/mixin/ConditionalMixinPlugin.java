...
public class ConditionalMixinPlugin implements IMixinConfigPlugin {
    ...
    private boolean shouldNotApply(String mixinClassName) {
        if ((FMLLoader.getLoadingModList().getModFileById("speedrunnermod") != null || FMLLoader.getLoadingModList().getModFileById("qualityofqueso") != null) && mixinClassName.equals("net.dillon.simplekeybinds.mixin.FogRendererMixin")) {
            return true;
        }
        return false;
    }
